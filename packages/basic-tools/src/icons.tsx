...
// Categorization / Tab Icon - outlined only
const CategorizationIconSvg: SVGIconComponent = ({ variant = 'outlined' }) => {
  return <svg {...defaultSvgStyles} {...getVariantSvgStyles(variant)}>
    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
const CategorizationIcon: ToolIconComponent = makeSvgIcon(CategorizationIconSvg)
